...
import {isPlugin} from '@/lib/utils';
...
class SliderState {
  constructor(name) {
    if (
      isPlugin &&
      !window.__JUCE__.initialisationData.__juce__sliders.includes(name)
    )
      console.warn(
...
class ToggleState {
  constructor(name) {
    if (
      isPlugin &&
      !window.__JUCE__.initialisationData.__juce__toggles.includes(name)
    )
      console.warn(
...
class ComboBoxState {
  constructor(name) {
    if (
      isPlugin &&
      !window.__JUCE__.initialisationData.__juce__comboBoxes.includes(name)
    )
      console.warn(
